...
@Composable
fun JobListLoading(modifier: Modifier = Modifier) {
    LazyColumn(
...
@Composable
private fun JobListLoadingPreviewSurface(darkTheme: Boolean) {
    SlicedWorkTheme(darkTheme = darkTheme) {
        Surface(
            modifier = Modifier.fillMaxSize(),
            color = MaterialTheme.colorScheme.background,
        ) {
            JobListLoading(modifier = Modifier.padding(16.dp))
        }
    }
}
...
@Composable
private fun PreviewJobListLoadingLight() = JobListLoadingPreviewSurface(darkTheme = false)

@Preview(name = "Loading Dark", showBackground = true)
@Composable
private fun PreviewJobListLoadingDark() = JobListLoadingPreviewSurface(darkTheme = true)